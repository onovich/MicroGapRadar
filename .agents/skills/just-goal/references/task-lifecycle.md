...
DRAFT -> READY -> IN_PROGRESS -> REVIEW -> ACCEPTED -> CLOSED
                      ...
                      |            + REQUEST_CHANGES loops to writer
...
- `REVIEW -> REQUEST_CHANGES`: reviewer requests changes.
- `REQUEST_CHANGES -> IN_PROGRESS`: lead routes the task back to the original writer or transfers ownership.
