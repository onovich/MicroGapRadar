...
3. If target thread exists in registry, use native `send_input`.
...
6. Never claim a route was sent unless `send_input` actually returned success or a platform-visible ID.
