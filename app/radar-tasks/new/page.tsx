...
import { toRadarTaskFormValues } from "@/lib/radar-task-view-models";

import { createRadarTaskAction } from "../actions";

export default function NewRadarTaskPage() {
  return (
    <main className="min-h-screen bg-panel/90 px-4 py-6 text-ink sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        ...
        <RadarTaskForm
          action={createRadarTaskAction}
          cancelHref="/radar-tasks"
          submitLabel="Create task"
          values={toRadarTaskFormValues()}
        />
      </div>
    </main>
  );
