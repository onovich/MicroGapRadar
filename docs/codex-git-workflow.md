...
<!-- initialized-at: 2026-06-28 00:25:28 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: MicroGapRadar
Repository root: D:/WebProjects/MicroGapRadar
Machine config: `
...
```
powershell
git -c safe.directory=D:/WebProjects/MicroGapRadar status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/MicroGapRadar push -u origin HEAD
```
